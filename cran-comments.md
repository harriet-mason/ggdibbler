...
* Removed the vignette link, sorry I missed it last time.
...
* Incremented version because we removed alpha parameter

* Fixed the contmap bug

* Reduced the computation time of the geom_contour_sample example
