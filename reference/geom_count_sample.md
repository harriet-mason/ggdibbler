...
Identical to geom_count, except that it will accept a distribution in
...
- geom, stat:
  ...
  [`geom_count()`](https://ggplot2.tidyverse.org/reference/geom_count.html)
  and
  [`stat_sum()`](https://ggplot2.tidyverse.org/reference/geom_count.html).
