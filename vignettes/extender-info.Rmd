---
title: "UNFINISHED: Info for ggplot extenders"
...
## Like a dog, your ggplot extension *can* learn new tricks
...
### Scales
Honestly, if your package implements new scales, I would hold off on this one until the `ggdibbler` scales system is more built up. You can still try, if you want, but I am not making any promises on the usability of the function you spit out. Technically `ggdibbler` doesn't even 

So long as distributional So, I will explain how the scales work, and you can decide for yourself if you want to 


### Nested Positions
If you want to nest your postion, this is not as easy as the others. The nested position system can't really be extended upon yet because 
