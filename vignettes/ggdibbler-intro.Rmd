...
Even with this list,`ggdibbler` does not implement this full nested grammar of graphics. The package would be greatly expanded by a full nested positioning system and having a quantile variation of all the `stat_*_sample` functions, but these features will take time.
