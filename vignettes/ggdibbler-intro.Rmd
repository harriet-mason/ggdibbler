...
This is the short version of what `ggdibbler` does, and if you are only here for the functionality of the package, feel free to skip to the examples section. If you are interested in *how* `ggdibbler` works you will need to read the full vignette.
...
Now that you understand the technicalities of `ggdibbler` it is time to put your knowledge to good use and get out there and try to make some graphics.
