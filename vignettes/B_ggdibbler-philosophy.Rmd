...
Gather around children and let us tell you the philosophical underpinnings of our uncertainty visualisation package. The long version of the approach (which is actually think it is a good read despite being a paper) is written up in the a preprint [here](https://arxiv.org/abs/2411.10482). A shorter version of it was given as a talk at UseR!2025 [available here](https://www.youtube.com/watch?v=gqhgD997PzY). The cliff notes version of these explanations is what makes up this section.
...
We decided to call this goal "signal suppression" in reference to one of the few papers that seemed to consistently apply the "visualising uncertainty as noise" philosophy, [Value Supressing Uncertainty Palettes](https://dl.acm.org/doi/10.1145/3173574.3174216). The only reason we didn't call it value suppression, is because we are not actually suppressing any individual values, but rather the "plot level" take away.
